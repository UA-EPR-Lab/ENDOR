...
# Class Methods
    ...
    def lineplot(self):
        ...
        plt.figure()
        plt.plot(self.spect.x_axis, self.spect.amp.real, 'k', linewidth=1.5)
        plt.plot(self.spect.x_axis, self.spect.phased_complex.imag, 'r', linewidth=1.5)
        plt.plot(self.spect.x_axis, self.spect.phased, 'b', linewidth=1.5)

        plt.xlim([self.spect.x_axis[0], self.spect.x_axis[-1]])
        plt.xlabel('RF Frequency ('+self.spect.x_unit+')', fontsize=14)
